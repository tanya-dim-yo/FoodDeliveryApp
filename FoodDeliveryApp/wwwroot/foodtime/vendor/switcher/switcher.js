    ...
    <div class="theme-design theme-option row" opt="themeFullColor">
      <div class="theme-box col-md-12">
        ...
        <ul val="themeFullColor" class="color-skins theme-panel-save">
          <li class="active">
            <a class="theme-skin skin-1 theme-color" href="javascript:void(0);" data-color-theme="color_1" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="../foodtime/images/logo.png, ../foodtime/images/logo-white.png, ../foodtime/images/logo-white.png"></a>
          </li>
          <li>
            <a class="theme-skin skin-2 theme-color" href="javascript:void(0);" data-color-theme="color_2" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="../foodtime/images/logo-2.png, ../foodtime/images/logo-white-2.png, ../foodtime/images/logo-white-2.png"></a>
          </li>
          <li>
            <a class="theme-skin skin-3 theme-color" href="javascript:void(0);" data-color-theme="color_3" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="../foodtime/images/logo-3.png, ../foodtime/images/logo-white-3.png, ../foodtime/images/logo-white-3.png"></a>
          </li>
          <li>
            <a class="theme-skin skin-4 theme-color" href="javascript:void(0);" data-color-theme="color_4" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="../foodtime/images/logo-4.png, ../foodtime/images/logo-white-4.png, ../foodtime/images/logo-white-4.png"></a>
          </li>
          <li>
            <a class="theme-skin skin-5 theme-color" href="javascript:void(0);" data-color-theme="color_5" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="../foodtime/images/logo-5.png, ../foodtime/images/logo-white-5.png, ../foodtime/images/logo-white-5.png"></a>
          </li>
          <li>
            <a class="theme-skin skin-6 theme-color" href="javascript:void(0);" data-color-theme="color_6" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="../foodtime/images/logo-6.png, ../foodtime/images/logo-white-6.png, ../foodtime/images/logo-white-6.png"></a>
          </li>
          <li>
            <a class="theme-skin skin-7 theme-color" href="javascript:void(0);" data-color-theme="color_7" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="../foodtime/images/logo-7.png, ../foodtime/images/logo-white-7.png, ../foodtime/images/logo-white-7.png"></a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="theme-design row mb-0 theme-background-wrapper">
      <div class="col-md-12 theme-box theme-option mb-4" opt="backgroundColor">
        ...
        <ul val="backgroundColor" class="bg-color-switcher theme-panel-save">
          <li>
			<a class="bg-color-0" dir="color_0" href="javascript:void(0);"><img src="../foodtime/vendor/switcher/demo.png" alt=""></a>
		</li>
		  <li>
      ...
      <div class="col-md-12 theme-box theme-option mb-4" opt="backgroundImage">
        ...
        <ul val="backgroundImage" class="background-switcher theme-panel-save">
          <li>
            <img src="../foodtime/images/switcher/small/background/bg1.jpg" dir="../foodtime/images/switcher/large/background/bg1.jpg" alt="">
          </li>
          <li>
            <img src="../foodtime/images/switcher/small/background/bg2.jpg" dir="../foodtime/images/switcher/large/background/bg2.jpg" alt="">
          </li>
          <li>
            <img src="../foodtime/images/switcher/small/background/bg3.jpg" dir="../foodtime/images/switcher/large/background/bg3.jpg" alt="">
          </li>
          <li>
            <img src="../foodtime/images/switcher/small/background/bg4.jpg" dir="../foodtime/images/switcher/large/background/bg4.jpg" alt="">
          </li>
          <li>
            <img src="../foodtime/images/switcher/small/background/bg5.jpg" dir="../foodtime/images/switcher/large/background/bg5.jpg" alt="">
          </li>
          <li>
            <img src="../foodtime/images/switcher/small/background/bg6.jpg" dir="../foodtime/images/switcher/large/background/bg6.jpg" alt="">
          </li>
          <li>
            <img src="../foodtime/images/switcher/small/background/bg7.jpg" dir="../foodtime/images/switcher/large/background/bg7.jpg" alt="">
          </li>
        </ul>
      </div>
      <div class="col-md-12 theme-box theme-option" opt="backgroundPattern">
        ...
        <ul val="backgroundPattern" class="pattern-switcher theme-panel-save">
          <li>
            <img src="../foodtime/images/switcher/small/pattern/pt1.jpg" dir="../foodtime/images/switcher/large/pattern/pt1.jpg" alt="">
          </li>
          <li>
            <img src="../foodtime/images/switcher/small/pattern/pt2.jpg" dir="../foodtime/images/switcher/large/pattern/pt2.jpg" alt="">
          </li>
          <li>
            <img src="../foodtime/images/switcher/small/pattern/pt3.jpg" dir="../foodtime/images/switcher/large/pattern/pt3.jpg" alt="">
          </li>
          <li>
            <img src="../foodtime/images/switcher/small/pattern/pt4.jpg" dir="../foodtime/images/switcher/large/pattern/pt4.jpg" alt="">
          </li>
          <li>
            <img src="../foodtime/images/switcher/small/pattern/pt5.jpg" dir="../foodtime/images/switcher/large/pattern/pt5.jpg" alt="">
          </li>
          <li>
            <img src="../foodtime/images/switcher/small/pattern/pt6.jpg" dir="../foodtime/images/switcher/large/pattern/pt6.jpg" alt="">
          </li>
          <li>
            <img src="../foodtime/images/switcher/small/pattern/pt7.jpg" dir="../foodtime/images/switcher/large/pattern/pt7.jpg" alt="">
          </li>
        </ul>
      </div>
    </div>
